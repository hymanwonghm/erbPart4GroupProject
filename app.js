...
console.log(username, password)
    // let authenticated_user = await knex('students').select(['id','username', 'password'])
    // const user = authenticated_user[0]
    const user = {username: 'Hyman', passwoed: '123456'}
    console.log(user)
